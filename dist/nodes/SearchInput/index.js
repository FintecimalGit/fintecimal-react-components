...
var SearchInput = function SearchInput(_ref) {
  ...
  var selectAdorment = function selectAdorment() {
    if (clear && value && !disabled) {
      return /*#__PURE__*/_react.default.createElement(_core.InputAdornment, {
        ...
        onClick: onClear,
        tabIndex: "-1"
      }, /*#__PURE__*/_react.default.createElement(_icons.Clear /*className={classes.icon}*/, null)));
  ...
  var searchValue = /*#__PURE__*/function () {
  ...
  (0, _react.useEffect)(function () {
    if (!value) setResults([]);
    if (value && searchingFound()) setResults([]);else if (value) searchValue(value);
  }, [value]);
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    text: errorMessage
  }), results.length > 0 && /*#__PURE__*/_react.default.createElement(_core.List, {
