...
var defaultData = [{
  ...
  "conditionWrong": {
    ...
    "conditions": [[{
      ...
      "value": ["Apoyo Infonavit", "Cofinavit", "FOVISSSTE para todos", "Cuenta Infonavit y Crédito Bancario"]
    }], [{
      "concept": "Aforo 80",
      "field": "64dbe1e7067071a24e3d83c2",
      "operator": "menor",
  ...
  "conditionWrong": {
    ...
    "conditions": [[{
      ...
      "field": "64dac1f2067071a24e24d588",
      "operator": "includesSome",
      "value": ["Apoyo Infonavit", "Cofinavit", "Cuenta Infonavit y Crédito Bancario", "FOVISSSTE para todos"]
    }]]
  }
}, {
  ...
  "conditionWrong": {
    ...
    "conditions": [[{
      ...
      "field": "64dac1f2067071a24e24d588",
      "operator": "includesSome",
      "value": ["Cofinavit", "Apoyo Infonavit"]
    }], [{
      "concept": "Tipo de ingresos",
      "field": "64b1ddafb1993273413802db",
      "operator": "igual",
